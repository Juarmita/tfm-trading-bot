...
- **Enlaces del Tribunal**:
  ...
  - *Despliegue del Frontend*: `https://frontend-97838ntlj-juarmitas-projects.vercel.app`
...
- **14 Pruebas Unitarias Integradas y Verificadas**:
  ...
  - `test_ai_engine.py`: Valida cálculo de SMA50/200, asignación de pesos e inferencia algorítmica para Largo y Corto Plazo.
...
> *"Para garantizar la reproducibilidad y el rigor académico del desarrollo, se construyó una batería de pruebas unitarias que cubre los tres módulos principales. Validamos que el simulador de broker lance errores si el capital requerido supera el balance del usuario y comprobamos que las cachés respondan correctamente. El pipeline de GitHub Actions bloquea la integración de cualquier código que no compile o rompa los tests."*
...
**🎤 Notas del Presentador (Tiempo sugerido: 20:00 - 23:00)**:
...
## 11. Resultados y Evidencia en Desarrollo
...
**🎤 Notas del Presentador (Tiempo sugerido: 23:00 - 25:00)**:
...
## 12. Modularidad: Transición Hacia un Broker Real
...
**🎤 Notas del Presentador (Tiempo sugerido: 25:00 - 27:00)**:
...
## 13. Contribución Académica y Cumplimiento de Criterios
...
| **Reproducibilidad Científica** | Batería de tests parametrizados y seed de base de datos SQL | `/tests/` y `/supabase/migrations/` |
| **Accesibilidad del Software** | Foco de teclado y trampas en Drawer cumpliendo directrices WCAG/ARIA | `InvestmentFlowDrawer.tsx` |

---

**🎤 Notas del Presentador (Tiempo sugerido: 27:00 - 28:30)**:
...
## 14. Conclusiones y Referencias Bibliográficas
...
**🎤 Notas del Presentador (Tiempo sugerido: 28:30 - 30:00)**:
